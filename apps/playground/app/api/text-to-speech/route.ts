import { experimental_generateSpeech as generateSpeech, AISDKError, APICallError } from 'ai';
import { elevenlabs } from '@elevenlabs/elevenlabs';

export const runtime = 'edge';

export async function POST(request: Request) {
  const { text, model = 'eleven_turbo_v2_5', voice = 'Rachel' } = await request.json();
