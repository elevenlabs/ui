...
import {
  ...
  ResizablePanel,
  ResizablePanelGroup,
} from '@elevenlabs/ui/components/resizable';
...
import {
  ToggleGroup,
  ToggleGroupItem,
} from '@elevenlabs/ui/components/toggle-group';
    ...
    <div className="flex flex-col gap-2 lg:hidden">
      ...
      {item.meta?.mobile === 'component' ? (
        ...
        <div className="overflow-hidden rounded-xl border">
          <Image
            src={`/r/styles/audio-components/${item.name}-light.png`}
            alt={item.name}
          ...
          />
          <Image
            src={`/r/styles/audio-components/${item.name}-dark.png`}
            alt={item.name}
            data-block={item.name}
            width={1440}
            height={900}
